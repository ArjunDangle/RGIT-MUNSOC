    ...
    <section ref={ref} className="py-20 bg-pure-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-3xl md:text-4xl font-semibold font-playfair text-charcoal-grey mb-6">Our Mission</h3>
            <p className="text-charcoal-grey/80 text-lg font-inter leading-relaxed mb-6">
            ...
            <p className="text-charcoal-grey/80 text-lg font-inter leading-relaxed">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-deep-navy p-8 rounded-lg border border-muted-gold/30">
              ...
              <div className="flex items-center space-x-4 mt-6">
                <div className="text-center">
                  <div className="text-3xl font-bold font-playfair text-sky-blue">500+</div>
                  <div className="text-sm font-inter text-pure-white/70">Delegates Trained</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold font-playfair text-sky-blue">50+</div>
                  <div className="text-sm font-inter text-pure-white/70">Conferences</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold font-playfair text-muted-gold">5</div>
